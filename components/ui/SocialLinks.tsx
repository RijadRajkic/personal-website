...
interface SocialLinksProps {
 /** Tailwind classes applied to each anchor (colors, hover state) */
 linkClassName?: string;
 /** Tailwind classes applied to each icon */
...
export default function SocialLinks({
 linkClassName = "text-(--color-text-muted)/60 transition hover:text-(--color-text)",
